...
export const counterIncreaseAC = () => ({ type: 'APP/COUNTER-INCREASE' } as const)

export const getCurrentCounterValueAC = (currentCounterValue: number) => ({ type: 'APP/GET-CURRENT-COUNTER-VALUE', currentCounterValue } as const)
