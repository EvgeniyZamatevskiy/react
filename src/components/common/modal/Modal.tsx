...
export const Modal: React.FC<ModalPropsType> = ({
  ...
  return (
    <div
      className={clsx('w-full h-full bg-dark-transparent fixed top-0 left-0 z-[100]', classNameModal)}
      onClick={deactivateVisibleModal}
    >
      <div
        className={clsx('absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2', classNameContent)}
