...
const classes = {
  default: `inline-flex items-center justify-center text-center gap-2.5 py-[21px] 
rounded-[10px] leading-3 text-black-primary font-semibold disabled:text-[#828282]`,
