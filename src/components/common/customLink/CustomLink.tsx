...
// <NavLink className={({ isActive }) => isActive ? style.activeLink : EMPTY_STRING} to={'/'}>Home</NavLink>
// <NavLink style={({ isActive }) => ({ color: isActive ? 'red' : EMPTY_STRING })} to={'/'}>Home</NavLink>
